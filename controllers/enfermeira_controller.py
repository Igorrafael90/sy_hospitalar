...
def associa_enfermeira_hospital():
    ...
    if qnt_enfermeiras != 0 and qnt_hospitais != 0:
        ...
        while True:
            ...
            if alterna == 0:
                ...
                if hospitais_associados == []:
                    ...
                    registro = pega_info_db(
                        comando, {'coren': coren_enfermeira})
                    if len(registro) != 0:
            ...
            if alterna == 0:
                opcao = filter_opcao(qnt_enfermeiras)
            else:
        ...
        if opcao != 0:
            ...
            associa = altera_db(
                comando, {'cnpj': cnpj_hospital, 'coren': coren_enfermeira})
...
def associa_enfermeira_medico():
    ...
    if qnt_enfermeiras != 0 and qnt_medicos != 0:
        ...
        if opcao != 0:
            ...
            associa = altera_db(
                comando, {'crm': crm_medico, 'coren': coren_enfermeira})
    ...
    if qnt_enfermeiras != 0:
        ...
        if opcao != 0:
            ...
            if dado != 0 and opcao != 0:
                comando = '''UPDATE Enfermeira SET {coluna} = :dado WHERE coren = :coren'''.format(
                    coluna=tipo_dado)
...
def lista_hospitais_enfermeira():
    ...
    if len(enfermeiras) != 0:
        ...
        while True:
            ...
            opcao = filter_opcao(len(enfermeiras))
